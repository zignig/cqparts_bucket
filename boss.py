...
class Boss(cqparts.Part):
    ...
    def make(self):
        ...
        stem = cq.Workplane("XY").circle(self.stem_diam / 2).extrude(self.stem_length).translate((0,0,-self.stem_length))
    ...
    def mate_top(self, offset=0):
        return Mate(
            self,
            CoordSystem(origin=(0, 0, self.boss_length+offset), xDir=(1, 0, 0), normal=(0, 0, 1)),
        )
