...
# lifted for testing from cqparts_template
# cqparts/src/cqparts_template/clamp/peg.py
...
class _Spring(cqparts.Part):
    ...
    def make(self):
        spring = (
            cadquery.Workplane("XY", origin=(0, 0, -(self.width / 2 + self.wire_diam)))
            .circle(self.diam / 2)
            .circle((self.diam / 2) - self.wire_diam)
...
class ClothesPeg(cqparts.Assembly):
    ...
    spring_arm_length = PositiveFloat(
        17.5, doc="length of spring's arm converting torque to closing force"
    )
    ...
    def make_constraints(self):
        ...
        return [
            ...
            constraint.Coincident(spring.mate_origin, bottom.mate_spring_center),
        ]
